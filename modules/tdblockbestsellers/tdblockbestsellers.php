...
class tdblockbestsellers extends Module
{
	...
	{
            		$best_sellers = $this->getBestSellers($params,50);
	...
	{
		$best_sellers = $this->getBestSellers($params, 4);
		if ($best_sellers === false)
			return;
		...
		return $this->display(__FILE__, 'tdblockbestsellers-right.tpl');
	}

	protected function getBestSellers($params,$count=4)
	{
		if (Configuration::get('PS_CATALOG_MODE'))
			return false;

		if (!($result = ProductSale::getBestSalesLight((int)($params['cookie']->id_lang), 0,$count)))
             ...
             public function hookDisplayFooter($params)
	{
		...
		return $this->display(__FILE__, 'tdblockbestsellers-footer.tpl');
	}
}