	...
	{else}
		...
		{if !$opc}
				<p class="cart_navigation clearfix">
					...
					{if !$is_guest}
						{if $back}
							<a href="{$link->getPageLink('order', true, NULL, "step=1&back={$back}&multi-shipping={$multi_shipping}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button btn btn-default">
                                                            <span><i class="icon-chevron-left"></i>
								{l s='Continue shopping'}</span>
							</a>
						{else}
							<a href="{$link->getPageLink('order', true, NULL, "step=1&multi-shipping={$multi_shipping}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button btn btn-default">
								<span><i class="icon-chevron-left"></i>
								{l s='Continue shopping'}</span>
							</a>
						{/if}
					{else}
						<a href="{$link->getPageLink('order', true, NULL, "multi-shipping={$multi_shipping}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button btn btn-default">
							<span><i class="icon-chevron-left"></i>
							{l s='Continue shopping'}</span>
						</a>
					{/if}
