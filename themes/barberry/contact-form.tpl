    ...
    <div class="row">
        <div class="span12">
                <header class="entry-header">
                    <h1 class="entry-title title-page"> {l s='Customer service'} - {if isset($customerThread) && $customerThread}{l s='Your reply'}{else}{l s='Contact us'}{/if}</h1>
                    <h2 class="sub-title-page">{l s=' Get in touch with us'}</h2>
...
{if $page_name !='index' && $page_name !='pagenotfound'}
 ...
 {if $themesdev.td_googlemap=='enable'}
<div class="container">
    <div class="row">
        <div class="span12">
     ...
     <div class="contact_map">
		<div id="gmap" class="notopmargin" style="height: 300px;"></div>
        ...
        <div id="map_overlay_bottom"></div>
                ...
                <script type="text/javascript">
                    ...
                    jQuery('#gmap').gMap({
                        address: '{$themesdev.td_gmapaddress}',
                        maptype: 'ROADMAP',
                         zoom: {$themesdev.td_mapzoom},
                         scrollwheel: true,
                         markers:[
                    		{
          		         address: '{$themesdev.td_gmapaddress}',
                                  html: '{$themesdev.td_gmapdesc}'
                    		}
                         ],
                         controls: {
                             panControl: true,
