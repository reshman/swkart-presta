...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				{if $back}
					<a href="{$link->getPageLink('order', true, NULL, "step=0&amp;back={$back}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button btn btn-default"><span><i class="icon-chevron-left"></i>{l s='Continue Shopping'}</span></a>
				{else}
					<a href="{$link->getPageLink('order', true, NULL, "step=0")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button btn btn-default"><span><i class="icon-chevron-left"></i>{l s='Continue Shopping'}</span></a>
				{/if}
