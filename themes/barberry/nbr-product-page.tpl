...
{if isset($p) AND $p}
	...
	{if $nb_products > $nArray[0]}
		<form action="{if !is_array($requestNb)}{$requestNb|escape:'html':'UTF-8'}{else}{$requestNb.requestUrl|escape:'html':'UTF-8'}{/if}" method="get" class="woocommerce-ordering  nbrItemPage">
				...
				{if is_array($requestNb)}
					...
					{/foreach}
				{/if}
				<select name="n" id="nb_item{if isset($paginationId)}_{$paginationId}{/if}" class="hasCustomSelect">
