...
<div class="header_shopbag_container">               
        ...
        <div class="shopping_cart overview">
            <a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">	
                    ...
                    <span class="minicart_items">
                        ...
                        <span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}"> {l s='0 items' mod='blockcart'}</span>
            ...
            {if !$PS_CATALOG_MODE}
             <div class="tdl_minicart_wrapper cart_block block exclusive">
                    <div class="tdl_minicart block_content">
                        <div class="bag-items">{l s='Recently added item(s)!' mod='blockcart'}</div>
                ...
                {/if}
                     ...
                     <div class="minicart_total_checkout">                                        
                                        {l s='Cart Subtotal' mod='blockcart'}<span><span class="amount price cart_block_total ajax_block_cart_total">{$total}</span></span>                                   
                                    </div>
                                                <a class="button minicart_cart_but" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}">{l s='View Cart' mod='blockcart'}</a>
                                                <a class="button minicart_checkout_but" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}">{l s='Check out' mod='blockcart'}</a>
    ...
    <a class="tdl_small_shopbag" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">	
          <span class="ajax_cart_quantity{if $cart_qties == 0} unvisible{/if}">{$cart_qties}</span>
